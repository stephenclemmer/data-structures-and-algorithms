...
const typeNum = (arr) => {
  // Solution code here...
  let integers = arr.filter(function(val, idx){
...
const containsAnd = (arr) => {
  // Solution code here...
  let hasAnd = arr.filter(function(val){
    return val.includes('and');
  })
  // Solution code here...
  return hasAnd
};
...
const oddValues = (arr) => {
  // Solution code here...
  let oddOnly = arr.filter(function (val) {
    return (val % 2);
  });
  return oddOnly;
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let allowed = arr.filter(function (n){
