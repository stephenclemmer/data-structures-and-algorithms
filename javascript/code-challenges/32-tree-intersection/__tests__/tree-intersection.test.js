...
describe('Testing the tree-intersection.js file', () => {
  ...
  test('Testing the tree_intersection function with no matches', () => {
    let tree1 = new BinaryTree();
    let tree2 = new BinaryTree();
    ...
    tree2.root = new Node(42);
    tree2.root.left = new Node(101);
    tree2.root.right = new Node(600);
    tree2.root.left.left = new Node(15);
    tree2.root.left.right = new Node(161);
    tree2.root.left.right.left = new Node(126);
    tree2.root.left.right.right = new Node(176);
    tree2.root.right.left = new Node(201);
    tree2.root.right.right = new Node(351);
    tree2.root.right.right.left = new Node(4);
    tree2.root.right.right.right = new Node(501);
