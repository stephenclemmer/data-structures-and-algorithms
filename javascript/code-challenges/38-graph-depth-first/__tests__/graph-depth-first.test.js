...
const { Graph, Vertex } = require('../../38-graph-depth-first/graph-depth-first.js');
...
describe('Graphs', () => {
  it('should traverse depth first', () => {
    ...
    expect(graph.depthFirst(pandora)).toBe(['Pandora', 'Arendelle', 'Metroville', 'Monstroplolis', 'Naboo', 'Narnia']);
  });
});
